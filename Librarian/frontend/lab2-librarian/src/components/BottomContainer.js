    ...
    return (<section className="py-0">
        ...
        <div className="container">
            <div className="row justify-content-between pb-5 pt-8">
                <div className="col-12 col-lg-auto mb-5 mb-lg-0"><a className="d-flex align-items-center fw-semi-bold fs-3"
                                                                    href="#"> <img className="me-3"
                                                                                   src={`${logo}`}
                                                                                   width={100}
                                                                                   alt=""/>
                ...
                <div className="col-auto mb-3">
                    ...
                    <ul className="list-unstyled mb-md-4 mb-lg-0">
                        ...
                        <li className="mb-3"><a className="text-700 text-decoration-none" href="#!">Terms of Service</a>
                        </li>
                ...
                <div className="col-auto mb-3">
                    ...
                    <ul className="list-unstyled mb-md-4 mb-lg-0">
                        <li className="mb-3"><a className="text-700 text-decoration-none" href="#!">Development center</a>
                        </li>
                        <li className="mb-3"><a className="text-700 text-decoration-none" href="#!">API Documentation</a>
                        </li>
                        <li className="mb-3"><a className="text-700 text-decoration-none" href="#!">Writing Book</a></li>
                        <li className="mb-3"><a className="text-700 text-decoration-none" href="#!">Add a Book</a></li>
                    </ul>
                </div>
                <div className="col-auto mb-3">
                    <h6 className="mb-5 font-base fs-1">Develop </h6>
                    <ul className="list-unstyled mb-md-4 mb-lg-0">
                        ...
                        <li className="mb-3"><a className="text-700 text-decoration-none" href="#!">Report a Problem</a>
                        </li>
                        <li className="mb-3"><a className="text-700 text-decoration-none" href="#!">Suggesting Edits</a>
                        </li>
            ...
            <div className="row flex-center">
                <div className="col-auto mb-2">
                    <p className="mb-0 fs--1 my-2 text-center">&copy; This template is made with&nbsp;
                        <svg className="bi bi-suit-heart-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <div className="col-auto my-4">
                    <ul className="list-unstyled list-inline mb-0">
                        <li className="list-inline-item me-3"><a href="#!">
                            <svg className="bi bi-youtube" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                        ...
                        <li className="list-inline-item me-3"><a href="#!">
                            <svg className="bi bi-twitter" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                 fill="currentColor" viewBox="0 0 16 16">
                                <path
                        ...
                        <li className="list-inline-item me-3"><a className="text-decoration-none" href="#!">
                            <svg className="bi bi-facebook" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                 fill="currentColor" viewBox="0 0 16 16">
                                <path
                        ...
                        <li className="list-inline-item me-3"><a href="#!">
                            <svg className="bi bi-linkedin" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                 fill="currentColor" viewBox="0 0 16 16">
                                <path
                        ...
                        <li className="list-inline-item me-3"><a href="#!">
                            <svg className="bi bi-instagram" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                 fill="currentColor" viewBox="0 0 16 16">
                                <path
